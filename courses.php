                    ...
                    <div class="col-lg-9 col-md-9 column-right">
                        <div class="row courses__list ">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/hadoop-online-training.jpg" alt=""></div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/hadoop-testing-online-training.png" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/bigdata-hadoop-administration-online-training.jpg" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/blueprism-online-training.png" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/cyber-security-online-training.jpg" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/iot-online-training.png" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/ibm-aix-online-training.png" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/abinto.jpg" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/microsoft-azure-online-training.png" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/build-and-release-online-training.png" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/snaplogic-online-training.jpg" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/java-online-training.jpg" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/oracle-dba-online-training.jpg" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/oracle-apps-technical-training.png" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/oracle-access-management-admin-online-training.jpg" alt=""></div>
                                    </div>
                                    <div class="col-equal courses__content"><a class="courses__content__title" href="<?php echo $pathPrefix ?>oracle-osb-online-training.php">oracle-access-management-admin-online-training</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/oracle-osb-online-training.png" alt=""></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/cloud-computing-with-aws-online-training.png" alt=""></div>
                                    </div>
                                    <div class="col-equal courses__content"><a class="courses__content__title" href="<?php echo $pathPrefix ?>cloud-computing-with-aws-online-training.php">Cloud Computing With ASWS online Training</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 courses__item">
                                <div class="courses__wapper">
                                    <div class="col-equal courses__top">
                                        <div class="courses__top__wapper"><img class="courses__top__image" src="<?php echo $pathPrefix ?>assets/img/course/digital-marketing-online-training.png" alt=""></div>
                                    </div>
                                    <div class="col-equal courses__content"><a class="courses__content__title" href="<?php echo $pathPrefix ?>digital-marketing-online-training.php">Digital Marketing Online Training</a>
                                    </div>
                                </div>
                            </div>
                        </div>
