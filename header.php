            ...
            <nav class="navbar navbar-inverse header-top__top menu-main">
                ...
                <div class="nav navbar-nav navbar-right nav-right nav-right--login">
                   <ul class="nav navbar-nav menu-main__list ">
                    ...
                    <li class="menu-main__item "><a class="menu-main__link " href="<?php echo $pathPrefix ?>ready-to-deploy">Ready To Deploy </a></li>
                    <li class="menu-main__item "><a class="menu-main__link " href="<?php echo $pathPrefix ?>careers">Careers</a></li>
                    <li class="menu-main__item "><a class="menu-main__link " href="<?php echo $pathPrefix ?>enroll">Enroll </a></li>
...
<div class="modal fade in signin-form" id="modal-enroll" role="dialog">
